...
from .makerdao import MAKERDAO_CLASSIFIER_SPECS
from .dodo import DODO_CLASSIFIER_SPECS
from .opensea import OPENSEA_CLASSIFIER_SPECS
from .erc721 import ERC721_CLASSIFIER_SPECS
from .sudoswap import SUDOSWAP_CLASSIFIER_SPECS
from .nftx import NFTX_CLASSIFIER_SPECS
...
ALL_CLASSIFIER_SPECS = (
    ...
    + MAKERDAO_CLASSIFIER_SPECS
    + DODO_CLASSIFIER_SPECS
    + OPENSEA_CLASSIFIER_SPECS
    + ERC721_CLASSIFIER_SPECS
    + SUDOSWAP_CLASSIFIER_SPECS
    + NFTX_CLASSIFIER_SPECS
    # NFTX_CLASSIFIER_SPECS
)
